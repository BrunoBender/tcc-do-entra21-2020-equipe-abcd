...
empreendedor boolean NOT NULL DEFAULT false,
...
produto boolean NOT NULL DEFAULT false,
...
criado_em timestamp without time zone NOT NULL DEFAULT NOW(),
editado_em timestamp without time zone NOT NULL DEFAULT NOW(),
data_conclusao character varying(15) NOT NULL DEFAULT 'Reporte em analise',
